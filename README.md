...
### `shibakova` 
Приложение, созданное на основе модели и развернутое в streamlit
[`facebook/blenderbot-400M-distill`](https://huggingface.co/facebook/blenderbot-400M-distill?text=Hey+my+name+is+Clara%21+How+are+you%3F). 

[Cсылка на репозиторий с кодом](https://github.com/sureshiba/chatbot)
