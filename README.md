...
### Основные функции
* Приложение позволяет пользователю в получить комментарии, связанные с этим видео.  Оно получает доступ к данным комментариев, включая текст и автора комментария.
